          ...
          <div className="flex flex-col gap-0 mb-12">
            {HERO_ROLES.map((role, index) => (
              <MotionH1
                ...
                className={`font-pixel text-[10vw] md:text-[5rem] lg:text-[6.5rem] leading-[0.85] font-black tracking-tighter uppercase whitespace-nowrap select-none ${roleColors[index % roleColors.length]} hover:translate-x-4 transition-transform cursor-default`}
              >
                {role}
              </MotionH1>
            ))}
